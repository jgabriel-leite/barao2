...
date: "Últimos dados disponíveis: `r barao2::meses(barao2::comerciobr_get_ultimomes())` de `r barao2::meses(barao2::comerciobr_get_ulimoano())`"
output:
  pdf_document:
...
O índice Grubel-Lloyd foi originalmente concebido para avaliar o comércio intraindústria de um produto determinado. O índice é usado neste relatório de forma agregada para diversos produtos, sendo cada classificação considerada uma “indústria” para f ins de cálculo do índice.
